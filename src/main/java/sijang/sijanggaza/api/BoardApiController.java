...
public class BoardApiController {
     ...
     */
    @Operation(summary = "User 게시판 목록 조회 v1.5", description = "파라미터로 받은 페이지를 불러옵니다.")
    ...
    @Operation(summary = "Querydsl을 이용한 User 게시판 목록 조회 v1.5", description = "파라미터로 받은 페이지를 불러옵니다.")
    @GetMapping("/api/v1_5/userBoardsQuerydsl")
    public Page<UserBoardResponseDTO> getBoardListOfUserV1_5WithQuerydsl(@RequestParam(value = "page", defaultValue = "0") int page, @RequestParam(value = "kw", defaultValue = "") String kw) {
        Page<UserBoardResponseDTO> boardPage = this.boardService.getListOfUserV1_5WithQuerydls(page, kw);
        return boardPage;
    }
     ...
     */
    @Operation(summary = "User 게시판 목록 조회 v2", description = "파라미터로 받은 페이지를 불러옵니다.")
     ...
     */
    @Operation(summary = "User 게시판 목록 조회 v3", description = "파라미터로 받은 페이지를 불러옵니다.")
     ...
     * 게시글 상세
     */
    @Operation(summary = "User 게시글 상세보기", description = "파라미터로 받은 게시글을 불러옵니다.")
     ...
     * 게시글 생성
     */
    @Operation(summary = "User 게시글 생성", description = "파라미터로 받은 사용자 ID와 BoardForm을 통해 게시글을 생성합니다.")
     ...
     * 게시글 수정
     */
    @Operation(summary = "User 게시글 수정", description = "파라미터로 받은 게시글 ID와 BoardForm을 통해 게시글을 수정합니다.")
     ...
     * 게시글 삭제
     */
    @Operation(summary = "User 게시글 삭제", description = "파라미터로 받은 게시글을 삭제합니다.")
     ...
     * N+1 문제 해결, 컬렉션 패치 조인으로 페이징 불가할 수 있음
     */
    @Operation(summary = "Ceo 게시판 목록 조회 v2", description = "파라미터로 받은 페이지를 불러옵니다.")
     ...
     * batch_fetch_size로 N+1 문제 방지
     */
    @Operation(summary = "Ceo 게시판 목록 조회 v3", description = "파라미터로 받은 페이지를 불러옵니다.")
     ...
     * 게시글 상세
     */
    @Operation(summary = "Ceo 게시글 상세보기 v1", description = "파라미터로 받은 게시글을 불러옵니다.")
    ...
    @Operation(summary = "Ceo 게시글 상세보기 v2", description = "파라미터로 받은 게시글을 불러옵니다.")
     ...
     * 게시글 생성
     */
    @Operation(summary = "Ceo 게시글 생성", description = "파라미터로 받은 사용자 ID와 ItemBoardForm을 통해 게시글을 생성합니다.")
     ...
     * 게시글 수정
     */
    @Operation(summary = "Ceo 게시글 수정", description = "파라미터로 받은 게시글 ID와 ItemBoardForm을 통해 게시글을 수정합니다.")
